...
import fr.ralala.netcap.net.layer.internet.utils.ICMPv4OptionLabel;
...
public class ICMPv4 extends Layer {
  ...
  public Protocol getProtocolUI() {
    return new Protocol("ICMPv4", "Internet Control Message Protocol v4");
  }
  ...
  public void buildDetails(final List<String> lines) {
    ...
    lines.add("  Rest of Header: 0x" + String.format(Locale.US, "%08x", getChecksum()));
  ...
  public void decodeLayer(final byte[] buffer, final Layer owner) {
    ...
    mRestOfHeader = NetworkHelper.ntohl(temp4);
    offset += temp4.length;
