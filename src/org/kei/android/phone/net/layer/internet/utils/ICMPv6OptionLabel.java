...
public enum ICMPv6OptionLabel {
  ...
  DEST_UNREACHABLE(1, "Destination Unreachable", new ICMPv6CodeDestinationUnreachable()),
  PACKET_TOO_BIG(2, "Packet Too Big", null),
  TIME_EXCEEDED(3, "Time Exceeded", new ICMPv6CodeTimeExceeded()),
  PARAMETER_PROBLEM(4, "Parameter Problem", new ICMPv6CodeParameterProblem()),
  ...
  RR(138, "Router Renumbering", new ICMPv6CodeRouterRenumbering()),
  ICMP_NIQ(139, "ICMP Node Information Query", new ICMPv6CodeNodeInformationQuery()),
  ICMP_NIR(140, "ICMP Node Information Response", new ICMPv6CodeNodeInformationResponse()),
